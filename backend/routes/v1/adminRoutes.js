...
import { idParamSchema, roleSchema, taskQuerySchema } from "../../validators/taskValidators.js";
...
import { getAllUsers, 
    ...
    permanentDeleteTask, 
    restoreTask,  
    getDeletedTasks} from "../../controllers/adminControllers.js";
...
router.delete("/user/:id/permanent",validateParams(idParamSchema),permanentDeleteUser)
router.patch("/user/:id/role",validateParams(idParamSchema),validate(roleSchema),updateUserRole);
